...
// ´úÂëÀ´Ô´£º https://github.com/simco50/CppDelegates
...
#include <assert.h>
#define DELEGATE_ASSERT(expression, ...) JY_ASSERT(expression)
#endif
...
public:
	...
	virtual bool IsExecute() { return GetOwner() != nullptr; }
...
public:
	...
	RawDelegate()
		: m_pObject(nullptr), m_Function(nullptr), m_Payload()
	{}
...
private:
	unsigned int m_Id;
	SYSTEM_API static unsigned int CURRENT_ID;
...
public:
	...
	void Signal(DelegateHandle& handle, Args ...args)
	{
		Lock();
		for (size_t i = 0; i < m_Events.size(); ++i)
		{
